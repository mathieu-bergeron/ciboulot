...
(function() {
  ...
  MarkdownService = (function(_super) {
    ...
    MarkdownService.prototype.html_of_directive = function(directive) {
      var args, extension, filename, first_line, i, last_line, path, path_id, retour, separateurs, seulement_les_separateurs, touche, touches, _i, _j, _len, _ref3;
      switch (directive.name) {
        ...
        case "kbd":
          ...
          retour = "";
          for (i = _j = 0, _ref3 = seulement_les_separateurs.length; 0 <= _ref3 ? _j <= _ref3 : _j >= _ref3; i = 0 <= _ref3 ? ++_j : --_j) {
            touche = touches[i];
