...
(function() {
  ...
  BaseDirective = (function(superClass) {
    extend(BaseDirective, superClass);
  ...
  ErrorDirective = (function(superClass) {
    extend(ErrorDirective, superClass);
  ...
  ResourceDirective = (function(superClass) {
    extend(ResourceDirective, superClass);
    ...
    ResourceDirective.prototype.display = function() {
       ...
       */
      var cntl, name, resource_elm, results, src;
      this.$elm.empty();
      ...
      for (name in this.resource.data) {
        if (/[A-Z]|[_]|[0-9]/.test(name)) {
          results.push(this.$scope[name] = this.resource.data[name]);
        } else {
          results.push(void 0);
        }
      }
  ...
  EmbedDirective = (function(superClass) {
    extend(EmbedDirective, superClass);
  ...
  ModeDirective = (function(superClass) {
    extend(ModeDirective, superClass);
  ...
  HashDirective = (function(superClass) {
    extend(HashDirective, superClass);
  ...
  PartialDirective = (function(superClass) {
    extend(PartialDirective, superClass);
  ...
  MarkdownDirective = (function(superClass) {
    extend(MarkdownDirective, superClass);
  ...
  FileDirective = (function(superClass) {
    extend(FileDirective, superClass);
    ...
    FileDirective.prototype.on_file = function() {
      var first_index, j, l, last_index, len, lines, ref;
  ...
  PopupDirective = (function(superClass) {
    extend(PopupDirective, superClass);
  ...
  ProcDirective = (function(superClass) {
    extend(ProcDirective, superClass);
  ...
  StepsDirective = (function(superClass) {
    extend(StepsDirective, superClass);
    ...
    StepsDirective.prototype.hide_all_steps = function() {
      var j, len, ref, results, step_elm;
      ref = this.step_elms;
      results = [];
      for (j = 0, len = ref.length; j < len; j++) {
        step_elm = ref[j];
        results.push(step_elm.css('display', 'none'));
      }
      return results;
    };
    ...
    StepsDirective.prototype.display_steps = function() {
      var compiled_html, default_step, html, i, j, len, ref, results, step, step_path;
      this.step_elms = [];
      default_step = this.resource['data']['default'][0];
      ref = this.resource['data']['steps'];
      results = [];
      for (i = j = 0, len = ref.length; j < len; i = ++j) {
        ...
        results.push(this.step_elms.push(compiled_html));
      }
      return results;
    };

    StepsDirective.prototype.display_steps_static = function() {
      var compiled_html, default_step, html, i, id, j, len, ref, results, step, step_path, title_html;
      this.step_elms = [];
      default_step = this.resource['data']['default'][0];
      ref = this.resource['data']['steps'];
      results = [];
  ...
  StepDirective = (function(superClass) {
    extend(StepDirective, superClass);
    ...
    StepDirective.prototype.add_canvas_notes = function() {
      ...
      ref = this.image['notes'];
      results = [];
      for (j = 0, len = ref.length; j < len; j++) {
        note = ref[j];
        results.push(this.add_canvas_note(note));
      }
      return results;
    };
    ...
    StepDirective.prototype.step_titles_watcher = function() {
      var j, len, ref, step_title;
      ref = this.$scope.$parent.step_titles;
      for (j = 0, len = ref.length; j < len; j++) {
        step_title = ref[j];
    ...
    StepDirective.prototype.display = function() {
      var a, canvas_html, href, j, len, li, ol, step_index, step_title, step_titles;
      step_titles = [this.title_html.clone()];
      if (this.$scope.$parent.step_titles !== void 0) {
        step_titles = this.$scope.$parent.step_titles;
      }
      ol = angular.element("<ol></ol>");
      for (step_index = j = 0, len = step_titles.length; j < len; step_index = ++j) {
  ...
  RootDirective = (function(superClass) {
    extend(RootDirective, superClass);
  ...
  TabsDirective = (function(superClass) {
    extend(TabsDirective, superClass);
    ...
    TabsDirective.prototype.hide_all_tabs = function() {
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        results.push(tab.text_elm.css('display', 'none'));
      }
      return results;
    };
    ...
    TabsDirective.prototype.on_hide = function() {
      return this.$scope.current_tab = this.$scope.default_tab;
    };

    TabsDirective.prototype.display = function() {
      var default_tab, embed_html, j, len, new_tab, new_tab_text, ref, tab, tab_text, tab_text_html, tab_title_html, tabs, tabs_header, tabs_title, title_html;
      ...
      if (this.resource['data']['default_tab']) {
        default_tab = this.resource['data']['default_tab'];
        if (default_tab < this.tabs.length) {
          this.$scope.default_tab = default_tab;
          this.$scope.current_tab = default_tab;
        }
      }
  ...
  QuestionsDirective = (function(superClass) {
    extend(QuestionsDirective, superClass);
    ...
    QuestionsDirective.prototype.display = function() {
      var answer_html, error_cell, error_title, j, len, new_row, pair, question_html, ref, results, solution_cell, solution_title, title_row;
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        results.push(this.table_elm.append(new_row));
      }
      return results;
    };
