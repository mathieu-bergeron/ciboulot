...
(function() {
  ...
  angular;
  fabric;
  var AngularBase, BaseDirective, EmbedDirective, ErrorDirective, FileDirective, HashDirective, MarkdownDirective, ModeDirective, PartialDirective, PopupDirective, ProcDirective, QuestionsDirective, ResourceDirective, RootDirective, StepDirective, StepsDirective, TabsDirective, directives_module, install_angular_cls, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  ErrorDirective = (function(_super) {
    ...
    function ErrorDirective() {
      _ref = ErrorDirective.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  ResourceDirective = (function(_super) {
    ...
    function ResourceDirective() {
      _ref1 = ResourceDirective.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  FileDirective = (function(_super) {
    ...
    function FileDirective() {
      _ref7 = FileDirective.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
    ...
    FileDirective.prototype.on_file = function() {
      var first_index, l, last_index, lines, _i, _len, _ref8;
  ...
  PopupDirective = (function(_super) {
    ...
    function PopupDirective() {
      _ref8 = PopupDirective.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
  ...
  StepsDirective = (function(_super) {
    ...
    function StepsDirective() {
      _ref9 = StepsDirective.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
    ...
    StepsDirective.prototype.hide_all_steps = function() {
      var step_elm, _i, _len, _ref10, _results;
      _ref10 = this.step_elms;
      _results = [];
    ...
    StepsDirective.prototype.display_steps = function() {
      var compiled_html, default_step, html, i, step, step_path, _i, _len, _ref10, _results;
      this.step_elms = [];
      default_step = this.resource['data']['default'][0];
      _ref10 = this.resource['data']['steps'];
      _results = [];
    ...
    StepsDirective.prototype.display_steps_static = function() {
      var compiled_html, default_step, html, i, id, step, step_path, title_html, _i, _len, _ref10, _results;
      this.step_elms = [];
      default_step = this.resource['data']['default'][0];
      _ref10 = this.resource['data']['steps'];
      _results = [];
  ...
  StepDirective = (function(_super) {
    ...
    function StepDirective() {
      _ref10 = StepDirective.__super__.constructor.apply(this, arguments);
      return _ref10;
    }
    ...
    StepDirective.prototype.step_titles_watcher = function() {
      var step_title, _i, _len, _ref11;
      _ref11 = this.$scope.$parent.step_titles;
      for (_i = 0, _len = _ref11.length; _i < _len; _i++) {
        step_title = _ref11[_i];
  ...
  RootDirective = (function(_super) {
    ...
    function RootDirective() {
      _ref11 = RootDirective.__super__.constructor.apply(this, arguments);
      return _ref11;
    }
  ...
  TabsDirective = (function(_super) {
    ...
    function TabsDirective() {
      _ref12 = TabsDirective.__super__.constructor.apply(this, arguments);
      return _ref12;
    }
    ...
    TabsDirective.prototype.hide_all_tabs = function() {
      var tab, _i, _len, _ref13, _results;
      _ref13 = this.tabs;
      _results = [];
    ...
    TabsDirective.prototype.display = function() {
      var default_tab, embed_html, new_tab, new_tab_text, tab, tab_text, tab_text_html, tab_title_html, tabs, tabs_header, tabs_title, title_html, _i, _len, _ref13;
      ...
      this.tabs = [];
      _ref13 = this.resource['data']['tabs'];
      for (_i = 0, _len = _ref13.length; _i < _len; _i++) {
        tab = _ref13[_i];
  ...
  QuestionsDirective = (function(_super) {
    ...
    function QuestionsDirective() {
      _ref13 = QuestionsDirective.__super__.constructor.apply(this, arguments);
      return _ref13;
    }
    ...
    QuestionsDirective.prototype.display = function() {
      var answer_html, error_cell, error_title, new_row, pair, question_html, solution_cell, solution_title, title_row, _i, _len, _ref14, _results;
