...
(function() {
  ...
  ResourceDirective = (function(_super) {
    ...
    ResourceDirective.prototype.__injections = BaseDirective.prototype.__injections.concat(['$rootScope', 'fetch_resource', 'FETCHING']);
    ...
    ResourceDirective.prototype.display = function() {
      ...
      */
      ...
      var cntl, resource_elm;
      this.$elm.empty();
      cntl = this.resource.controller;
      resource_elm = angular.element("<div class='" + this.__name + "' ng-controller='" + cntl + "' src='" + this.resource_id + "' " + cntl + "=''></div>");
      resource_elm = (this.$compile(resource_elm))(this.$scope);
      return this.$elm.append(resource_elm);
    };
  ...
  MarkdownDirective = (function(_super) {
    ...
    MarkdownDirective.prototype.__injections = ModeDirective.prototype.__injections.concat(['MarkdownService']);

    MarkdownDirective.prototype.display = function() {
      var compiled_markdown, markdown_html, markdown_service, markdown_text;
      this.$elm.empty();
  ...
  ProcDirective = (function(_super) {
    ...
    function ProcDirective() {
      _ref7 = ProcDirective.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
    ...
    ProcDirective.prototype.show = function() {
      ...
      return this.partial_elm.css('display', 'block');
    };
