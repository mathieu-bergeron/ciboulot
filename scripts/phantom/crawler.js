...
new phantom.Crawler().crawl("http://ciboulot.ca/cegep/420-257-MO/01/formatif_01", 1, 
    function onSuccess(page) {
        ...
        console.log("<title>ciboulot</title>")
        console.log("<link rel='stylesheet' href='../css/ciboulot.css'/>")
        console.log("</head>")
